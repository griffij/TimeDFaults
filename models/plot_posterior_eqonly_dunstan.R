...
figname = 'plots/posterior_mu_eqonly_dunstan.png'  
...
figname = 'plots/posterior_alpha_eqonly_dunstan.png'
png(figname, units="in", width=6, height=6, res=300)
print("mean alpha")
print(mean(alpha))
...
figname = 'plots/posterior_hazard_rate1_eqonly_dunstan.png'
png(figname, units="in", width=6, height=6, res=300)
...
dev.off()
figname = 'plots/posterior_hazard_rate2_eqonly_dunstan.png'
png(figname, units="in", width=6, height=6, res=300)
